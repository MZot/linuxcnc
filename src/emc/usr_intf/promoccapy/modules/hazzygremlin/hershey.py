...
#
#    Added a 'fi' symbol 2017 Mit Zot
#    
#
...
class Hershey:
    ...
    # W
        [[(60, 20), (60, 400), (100, 440), (160, 440), (200, 400),
         ...
         [(200, 400), (200, 300)]],
    # fi
        [[(380.0, 230.0), (360.0, 290.0), (320.0, 330.0), (260.0, 350.0),
          (240.0, 350.0), (180.0, 330.0), (140.0, 290.0), (120.0, 230.0),
          (120.0, 210.0), (140.0,150.0), (180.0,110.0), (240.0, 90.0),
          (260.0, 90.0), (320.0,110.0), (360.0,150.0), (380.0, 230.0),
          (360.0,140.0),(320.0,100.0),
          (365.0, 30.0), (130.0, 400.0)]],
       ) 
